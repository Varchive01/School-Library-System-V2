...
$author=$_POST['author'];
$sql="INSERT INTO  tblissuedbookdetails(StudentID,FullName,BookName,Category,Author) VALUES(:studentid,:fullname,:bookname,:category,:author)";
...
<head>
    ...
    <title>Online Library Management System | Issue A Book</title>
...
<button type="submit" name="add" class="btn btn-info">Issue Book </button>
